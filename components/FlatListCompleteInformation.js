...
import { FlatList, View, Text, RefreshControl, StyleSheet, Image, TouchableOpacity } from 'react-native';
...
import ItemModal from './Modal';
  ...
  const FlatListWithPullToRefresh = ({ link }) => {
    ...
    const [title, setTitle] = useState('Jing jang');
...
return (
  <View style={{ flex: 1 }}>
    ...
    />
<ItemModal visible={modalVisible} title={title} imageUrl={selectedImage} closeModal={() => setModalVisible(false)} />
